...
// --- 1. THÈME CLAIR (Tes nouvelles couleurs Light) ---
...
val SecondaryLight = Color(0xFFFFFFFF) // Note: Secondary blanc sur fond blanc peut être invisible, attention
...
// --- 2. THÈME SOMBRE CLASSIQUE (Tes nouvelles couleurs Dark) ---
...
// --- 3. THÈME AMOLED (Dérivé de ton Dark, mais en Noir Pur) ---
val BackgroundAmoled = Color(0xFF000000)
val SurfaceAmoled = Color(0xFF000000)
val SurfaceVariantAmoled = Color(0xFF141414) // Très légèrement gris pour les bordures
val OutlineAmoled = Color(0xFF444444) // Gris foncé pour les contours